              ...
              <div className="right-container col-8">
                <div className="card py-2 px-3">
                  <nav className="navbar justify-content-between">
                    <h3>Edit Meja - {this.props.state.itemId}</h3>
                  </nav>
                    <div className="row">
                      <div className="col-4">
                    ...
                    <nav className="navbar justify-content-between">
                      ...
                      <div className='button-group'>
                        <button className="btn-danger btn-sm px-3 mr-3" onClick={() => this.props.method.deleteMeja()} >Delete</button>
                        <button className="btn-save btn-sm px-3" onClick={() => this.props.method.updateMeja()} >Simpan</button>                        
                      </div>
                    </nav>
                </div>
              </div>
